...
import com.example.quotes3.databinding.ActivityDrawerNavegationBinding
...
class DrawerNavigation : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityDrawerNavegationBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityDrawerNavegationBinding.inflate(layoutInflater)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.drawer_navegation, menu)
        return true
    }
